...
\_/ \|\____/\_/ \|\____\\____/                                 
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            EVAN AHAMED RAKIB 
\033[1;37m Facebook:         EVAN AHAMED RAKIB 
\033[1;37m Github  : 
...
def p_dump():
    ...
    try:
        ...
        print(f"File Saved To  {filepath} ")
        print(47*'-')
        input("Press enter to back ASHES Menu ")
        ASHES(allkey)
    except Exception as e:
        print("Error : %s"%e) 
...
def cutter():
    clear()
    print("Enter File Path / File Location \n")
    ashes = input('Put File Name:')
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +sarfraz)
    os.system('sort -r '+ashes+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + Ashes )
    print("New File Saved:" + sarfraz )
    print(47*'-')
    input(f"{S} Press Enter To Back Ashes Menu ")
    Ashes(allkey)       
